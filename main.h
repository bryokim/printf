...
int check(char c);
char *pick(const char *format, char *buf, va_list ap);

int convert_int(char c, char d, int n, char *s);
void print_int_base10(int n, char *s, int base);
void print_int(char c, char d, int n, int *i, char *s, char *buf, va_list ap);
void print_uint(unsigned int n, char *s);

void custom_str(char *s, char *str);
void print_str(char c, char *s, char *str);
